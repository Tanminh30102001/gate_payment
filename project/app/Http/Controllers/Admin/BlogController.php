...
class BlogController extends Controller
{
   ...
   public function __construct(BlogResource $resource)
   {
    ...
    public function store(BlogRequest $request)
    {
        ...
        $input = $request->only('title','category_id','description','photo','status','lang');
    ...
    {
        $this->resource->update($request->only('title','category_id','description','photo','status','lang'),$blog);
