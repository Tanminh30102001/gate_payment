...
class LanguageController extends Controller
{
    ...
    public function scanLangStrings(){
        $directory = base_path(); // Root directory of the project
        ...
        foreach ($phpFiles as $file) {
            ...
            $langStrings = array_merge($langStrings, $matches1[1], $matches2[1]);
        }

        $langStrings = array_unique($langStrings); // Remove duplicates
        Log::info('lang',$langStrings);
        return response()->json($langStrings);
    }
