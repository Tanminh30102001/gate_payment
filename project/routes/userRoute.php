<?php
use App\Http\Controllers\User\UtilitiesController;
...
Route::prefix('user')->name('user.')->middleware('maintenance')->group(function () {
    ...
    Route::middleware(['auth', 'email_verify', 'twostep'])->group(function () {
        ...
        Route::get('list-service', [UtilitiesController::class, 'listServiceApota'])->name('listServiceAptota');
        Route::get('service/{category}', [UtilitiesController::class, 'detailService'])->name('detailServiceApota');
        Route::get('get-bill', [UtilitiesController::class, 'userGetBillApota'])->name('getBillApota');
        Route::post('pay-bill', [UtilitiesController::class, 'userPayBillApota'])->name('userPayBillApota');
        // pay bill electric
        Route::get('electric-bill', [UtilitiesController::class, 'electricBill'])->name('electric');
        Route::post('electric-bill', [UtilitiesController::class, 'getBill']);//call get bill to RPA
        Route::post('electric-bill/pay', [UtilitiesController::class, 'payBillElectric'])->name('payBillElectric');
        // top up phone 
        Route::get('topup-phone', [UtilitiesController::class, 'topupPhone'])->name('topup');
        Route::post('topup-phone', [UtilitiesController::class, 'payTopupPhone']);
        //pay vetc
        Route::get('vetc', [UtilitiesController::class, 'vetc'])->name('vetc');
        Route::post('vetc', [UtilitiesController::class, 'payBillVetc']);
        //Pay internet
        Route::get('internet', [UtilitiesController::class, 'internet'])->name('internet');
        Route::post('internet', [UtilitiesController::class, 'checkBillInternet']);
        Route::post('pay-internet', [UtilitiesController::class, 'payBillInternet'])->name('payInternet');
        //transfer-money
