...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware('auth:admin')->group(function () {
        ...
        //Billing temporary
        Route::get('/billing',                 [AdminController::class, 'getBilling'])->name('billing')->middleware('permission:transactions');
        Route::get('/billing/{transactionId}',                 [AdminController::class, 'detailsBill'])->name('detailsBill')->middleware('permission:transactions');
        Route::post('/update-bill',                 [AdminController::class, 'updateBill'])->name('updateBill')->middleware('permission:transactions');
        ...
        Route::get('/scan-lang', [LanguageController::class, 'scanLangStrings'])->name('scan.lang');
        // admin language
