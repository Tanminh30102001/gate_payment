...
Route::middleware(['maintenance'])->group(function () {
    ...
    /////
    Route::get('/thanh-toan-dien-nuoc', [FrontendController::class, 'thanhToanDienNuoc'])->name('front.thanhtoandiennuoc');
    Route::post('/thanh-toan-dien-nuoc', [FrontendController::class, 'handleForm'])->name('front.handleThanhToanDienNuoc');
    Route::get('/get-bill-details', [FrontendController::class, 'getBillDetails'])->name('getBillDetails');
    ////////////
    ...
    Route::get('/fincare', [FrontendController::class, 'fincare'])->name('fincare');
