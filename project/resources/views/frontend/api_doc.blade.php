                ...
                <div class="col-lg-10">
                    <div class="documentation-wrapper">
                        <div class="documentation-item" id="intro">
                            ...
                            @lang('All calls to the') {{ $gs->title }} @lang('API require merchant authentication and merchant access key.') <a
                                href="{{ url('merchant/register') }}">@lang('Register')</a> @lang('for a  account to quickly get started').
                            <br>
                ...
                "date"  : "22-05-2022"
                        ...
                        <div class="documentation-item" id="payment">
                            ...
                            <p>
                                ...
                                <span>@lang('Payment verify end point'): <a
                                        href="javascript:void(0)">{{ url('payment/check-validity') }}</a></span>
                            </p>
