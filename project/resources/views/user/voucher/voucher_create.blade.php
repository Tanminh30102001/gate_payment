                ...
                <form action="" id="form" method="post">
                  @csrf
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-label">@lang('Select Price voucher Gotit ')</div>
                            <select class="form-select wallet shadow-none" name="product">
                                <option value="" selected>@lang('Select price')</option>
                                @foreach ($voucherGotiits as $voucherGotiit)
                                  <option value="{{$voucherGotiit->productId}}|{{$voucherGotiit->priceId}}" >{{numFormat($voucherGotiit->priceValue)}} VND</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="col-md-6">
