    ...
    <div class="navbar navbar-light">
      <div class="container-xl">
        <ul class="navbar-nav">
          ...
          <li class="nav-item dropdown {{menu(['user.electric','user.topup','user.internet','user.vetc'])}}">
            <a class="nav-link dropdown-toggle" href="#navbar-extra" data-bs-toggle="dropdown" data-bs-auto-close="outside" role="button" aria-expanded="false" >
              <span class="nav-link-icon d-md-none d-lg-inline-block">
            ...
            <div class="dropdown-menu">
              <a class="dropdown-item" href="{{route('user.listServiceAptota')}}" >
                @lang('Utilities service')
              </a>
              <a class="dropdown-item" href="{{route('user.topup')}}" >
                @lang('Top up phone')
              </a>
            </div>
          </li>
